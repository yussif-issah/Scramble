...
public class LevelThreeController {
	...
	static TextField field5=new TextField();
	...
	public static void getLevelThreeBoxes(ObservableList<Node> buttons, ObservableList<Node> fields) {
		...
		btn5.setOnDragDetected(new EventHandler<MouseEvent>() {
			@Override
			public void handle(MouseEvent event) {
				btn5.startFullDrag();
				SOUNDS.PlayDragSound();
		...
		field5.setOnMouseDragReleased(new EventHandler<MouseDragEvent>() {

			@Override
			public void handle(MouseDragEvent event) {
				// TODO Auto-generated method stub
				Button value=(Button) event.getGestureSource();
				field5.setText(value.getText());
				SOUNDS.PlayDropSound();
			}
	...
	public static void ScrambleLettersOnBoxes(String word) {
		...
		public static String getLettersOnBoxes() {
			String word=field1.getText()+field2.getText()+field3.getText()+field4.getText()+field5.getText();
			return word;
		}
